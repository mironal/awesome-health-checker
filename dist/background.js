...
},{"regenerator-runtime":"../node_modules/regenerator-runtime/runtime-module.js"}],"background.ts":[function(require,module,exports) {
"use strict";
...
var clientId = "4be04a7e12249b9ea66a";
var clientSecret = "29c5784cff71998589bbad9e441a8f3b8ab6780e";
var redirectUri = "https://pkedcjkdefgpdelpbcmbmeomcjbeemfm.chromiumapp.org/";
...
var exchangeCodeForToken = function exchangeCodeForToken(code) {
  return __awaiter(_this, void 0, void 0,
  /*#__PURE__*/
  _regenerator.default.mark(function _callee() {
    var url, response, text, parsedQuery;
    return _regenerator.default.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            url = "https://github.com/login/oauth/access_token?" + "client_id=" + clientId + "&client_secret=" + clientSecret + "&redirect_uri=" + redirectUri + "&code=" + code;
            _context.next = 3;
            return fetch(url);
          ...
          case 3:
            ...
            _context.t0 = Promise;
            _context.t1 = Error;
            _context.t2 = "Invalid response code: ".concat(response.status, ", body: ");
            _context.next = 10;
          ...
          case 10:
            ...
            _context.t5 = new _context.t1(_context.t4);
            return _context.abrupt("return", _context.t0.reject.call(_context.t0, _context.t5));
          ...
          case 16:
            ...
            return _context.abrupt("return", parsedQuery.access_token);

          case 23:
            return _context.abrupt("return", Promise.reject(new Error("Invalid response ".concat(text))));
        ...
        switch (_context3.prev = _context3.next) {
          ...
          case 2:
            ...
            return _context3.abrupt("return", new Promise(function (resolve, reject) {
              chrome.identity.launchWebAuthFlow(options, function (redirect) {
                  ...
                  return _regenerator.default.wrap(function _callee2$(_context2) {
                    while (1) {
                      switch (_context2.prev = _context2.next) {
                        ...
                        case 6:
                          code = parseQuery(new URL(redirect).search.replace(/^\?/, "")).code;
...
},{"@babel/runtime/regenerator":"../node_modules/@babel/runtime/regenerator/index.js"}]},{},["background.ts"], null)
